...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_root',type=str, default='../datasets/video-demoireing_v2/tcl/', help='path to our dataset IHD')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='tcl', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization]')
        ...
        parser.add_argument('--short_layers', type=int, default=6, help='resblocks')
