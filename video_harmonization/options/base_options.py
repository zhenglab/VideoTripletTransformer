...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_root',type=str, default='../datasets/HYouTube/', help='path to our dataset IHD')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='hytsample', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization]')
