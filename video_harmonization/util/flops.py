...
def print_model_flops(model, inputs=None, outputs_tokens=None, current=0, spatial_pos=None, three_dim_pos=None, t_tre_three_dim_pos=None,key_padding_mask=None, spatial_bs=None): #retinextr
# def print_model_flops(model, inputs, pos=None, mask_r=None, layers=[], encode_only=False, tgt_enc=None, ifm_image=None):
    ...
    output = model(inputs=inputs, outputs_tokens=outputs_tokens, current=current, spatial_pos=spatial_pos, three_dim_pos=three_dim_pos, t_tre_three_dim_pos=t_tre_three_dim_pos, key_padding_mask=key_padding_mask, spatial_bs=spatial_bs) #retinextr
