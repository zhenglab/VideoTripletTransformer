...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_root',type=str, default='../datasets/SDSD/outdoor_np/', help='path to our dataset IHD')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='sdsd', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization]')
        ...
        parser.add_argument('--loss_TR', type=str, default='rtc', help='temporal loss')
        
        
        parser.add_argument('--n_downsample', type=int, default=2, help='min 2')
        parser.add_argument('--short_layers', type=int, default=3, help='resblocks')
        parser.add_argument('--long_layers', type=int, default=3, help='resblocks')
        parser.add_argument('--deformable_depth', type=int, default=2, help='resblocks')
        parser.add_argument('--gpt_depth', type=int, default=2, help='resblocks')
